/**
 * @component Table
 * @description DaisyUI Table component with SQLI theme
      ...
      <tbody>
        <tr>
          ...
          <td>
            <div class="flex items-center gap-3">
              <div class="avatar">
                <div class="mask mask-squircle h-12 w-12 bg-primary flex items-center justify-center text-primary-content font-bold">
                  CG
                </div>
              </div>
              <div>
        ...
        <tr>
          ...
          <td>
            <div class="flex items-center gap-3">
              <div class="avatar">
                <div class="mask mask-squircle h-12 w-12 bg-secondary flex items-center justify-center text-secondary-content font-bold">
                  HH
                </div>
              </div>
              <div>
          ...
          <td>
            ...
            <br />
            <span class="badge badge-ghost badge-sm">Web Designer</span>
          </td>
          <td>Purple</td>
          <th>
            <button class="btn btn-ghost btn-xs">details</button>
...
export const Sizes = () => `
  <div class="flex flex-col gap-8">
    ...
    <div>
      <p class="text-sm mb-2 opacity-70">Medium (md - default)</p>
